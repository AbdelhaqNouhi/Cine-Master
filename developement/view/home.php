<?php
    require "../controller/post.controllee.php";
?>
...
<body>
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            ...
            <a class="navbar-mune col-2" href="../index.php">log Out</a> 
        ...
        <div class="container col-lg-8 col-sm-12 post">
            <div class="col-lg-12 col-sm-12">
                <div class="user">
                    ...
                    <form class="more" action="./" method="POST">
                        <div>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <!-- <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#staticBackdrop" type="submit" name="update">Update</a> -->
                            </ul>
                        </div>
                    </form>
                </div>      
                ...
                <form action="">
                    <div class="input-group commit">
                        ...
                        <a href="?send" type="submit"><svg xmlns="http://www.w3.org/2000/svg"class="bi bi-arrow-up-circle-fill send" viewBox="0 0 16 16">
